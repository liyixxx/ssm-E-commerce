...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="xin"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="15623854529"/>
		<input type="hidden" name="orderShipping.receiverState" value="湖北"/>
		<input type="hidden" name="orderShipping.receiverCity" value="武汉"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="洪山区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="武昌首义学院"/>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">xin</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">156****4529</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">湖北 武汉 洪山区</div>
						<div class="adr-m" limit="30">武昌首义学院</div>
						<div>100000</div>
